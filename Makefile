...
EXT_NAME=azure
EXTENSION_NAME_UPPERCASE=AZURE

DUCKDB_EXTENSION_AZURE_LINKED_LIBS=../../vcpkg_installed/wasm32-emscripten/lib/libazure-identity.a
...
WASM_LINK_TIME_FLAGS=-O3 -sSIDE_MODULE=2 -sEXPORTED_FUNCTIONS="_${EXT_NAME}_version,_${EXT_NAME}_init" ${DUCKDB_EXTENSION_AZURE_LINKED_LIBS}
